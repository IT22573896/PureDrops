                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ClipRRect(
                              ...
                              child: Image.asset(
                                'assets/district/Polonnaruwa.jpg',
                              ...
                              child: const Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 5),
                                    Text(
                                      'Households in Need of Clean Water: 120',
                                      style: TextStyle(
                                        fontSize: 16,
                                        color: Color(0xFF02055A),
                                      ),
                                    ...
                                    SizedBox(height: 5),
                                    Text(
                                      '• Poor water quality from sources',
                                      style: TextStyle(
                                        fontSize: 16,
                                        color: Color(0xFF02055A),
                                      ),
                                    ...
                                    SizedBox(height: 5),
                                    Text(
                                      'Immediate Action: Water management and quality improvement',
                                      style: TextStyle(
                                        fontSize: 16,
                                        color: Color(0xFF02055A),
                                      ),
