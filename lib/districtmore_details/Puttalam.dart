...
class Puttalam extends StatefulWidget {
  ...
  @override
  _PuttalamState createState() => _PuttalamState();
}

class _PuttalamState extends State<Puttalam> {
  @override
                              ...
                              child: const Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 5),
                                    Text(
                                      'Households in Need of Clean Water: 850',
                                      style: TextStyle(
                                        fontSize: 16,
                                        color: Color(0xFF02055A),
                                      ),
                                    ...
                                    SizedBox(height: 5),
                                    Text(
                                      '• Salinity in groundwater sources',
                                      style: TextStyle(
                                        fontSize: 16,
                                        color: Color(0xFF02055A),
                                      ),
                                    ...
                                    SizedBox(height: 5),
                                    Text(
                                      '• Seasonal droughts impacting supply',
                                      style: TextStyle(
                                        fontSize: 16,
                                        color: Color(0xFF02055A),
                                      ),
                                    ...
                                    SizedBox(height: 5),
                                    Text(
                                      'Immediate Action: Water quality monitoring and resource management',
                                      style: TextStyle(
                                        fontSize: 16,
                                        color: Color(0xFF02055A),
                                      ),
