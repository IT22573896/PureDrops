...
class Ratnapura extends StatefulWidget {
  const Ratnapura({super.key});

  @override
  _RatnapuraState createState() => _RatnapuraState();
}

class _RatnapuraState extends State<Ratnapura> {
  @override
                              ...
                              child: const Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 5),
                                    Text(
                                      'Households in Need of Clean Water: 100',
                                      style: TextStyle(
                                        fontSize: 16,
                                        color: Color(0xFF02055A),
                                      ),
                                    ...
                                    SizedBox(height: 5),
                                    Text(
                                      'Immediate Action: Pollution control and water conservation measures',
                                      style: TextStyle(
                                        fontSize: 16,
                                        color: Color(0xFF02055A),
                                      ),
