...
import 'package:Puredrops/water_consumption_questions/usage_question_3.dart';
import 'package:flutter/material.dart';

class UsageQuestion2 extends StatefulWidget {
  final int gallonCount; // Gallon count from the previous screen
  final double waterLevel; // Water level from the previous screen

  const UsageQuestion2(
      {super.key, required this.gallonCount, required this.waterLevel});

  @override
  State<UsageQuestion2> createState() => _UsageQuestion2State();
}

class _UsageQuestion2State extends State<UsageQuestion2> {
                          ...
                          child: Column(
                            children: [
                              Transform.translate(
                                ...
                                child: Image.asset(
                                  'assets/usages/Bathtub.png', // Update with the new image
                                  width: 180,
                                  height: 180,
                                ),
                              ),
                              ...
                              Transform.translate(
                                ...
                                child: const Align(
                                  ...
                                  child: Text(
                                    'How often do you use a bathtub for bathing?',
                                    style: TextStyle(
                                      fontSize: 22,
                                      fontFamily: 'Baloo 2',
                                      color: Colors.black,
                                  ...
                                  children: [
                                    ...
                                    ElevatedButton(
                                      onPressed: isAnswered
                                          ...
                                          : () {
                                              updateGallonCount(
                                                  30); // Assume 30 gallons for 'Daily'
                                            },
                                    ...
                                    ElevatedButton(
                                      onPressed: isAnswered
                                          ...
                                          : () {
                                              updateGallonCount(
                                                  20); // Assume 20 gallons for 'Weekly'
                                            },
                                      style: ElevatedButton.styleFrom(
                                        backgroundColor:
                                    ...
                                    ElevatedButton(
                                      onPressed: isAnswered
                                          ...
                                          : () {
                                              updateGallonCount(
                                                  10); // Assume 10 gallons for 'Monthly'
                                            },
                                      style: ElevatedButton.styleFrom(
                                        backgroundColor:
                              ...
                              Container(
                                ...
                                child: const Text(
                                  'Tip: Those relaxing soaks really are luxurious but it takes 70 gallons of water to fill the average bathtub to the brim. (Most people only fill it halfway, but still!)',
                                  style: TextStyle(
                                    fontSize: 14,
                              ...
                              ElevatedButton(
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => UsageQuestion3(
                                        gallonCount:
