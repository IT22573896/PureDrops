...
import 'package:Puredrops/water_consumption_questions/usage_question_4.dart';
import 'package:flutter/material.dart';

class UsageQuestion3 extends StatefulWidget {
  final int gallonCount; // Gallon count from the previous screen
  final double waterLevel; // Water level from the previous screen

  const UsageQuestion3(
      {super.key, required this.gallonCount, required this.waterLevel});

  @override
  State<UsageQuestion3> createState() => _UsageQuestion2State();
}

class _UsageQuestion2State extends State<UsageQuestion3> {
                          ...
                          child: Column(
                            children: [
                              Transform.translate(
                                ...
                                child: Image.asset(
                                  'assets/usages/Shower.png', // Update with the new image
                                  width: 180,
                                  height: 180,
                                ),
                              ),
                                  ...
                                  children: [
                                    ...
                                    ElevatedButton(
                                      onPressed: isAnswered
                                          ...
                                          : () {
                                              updateGallonCount(
                                                  10); // Assume 10 gallons for '5-10 MIN'
                                            },
                                    ...
                                    ElevatedButton(
                                      onPressed: isAnswered
                                          ...
                                          : () {
                                              updateGallonCount(
                                                  20); // Assume 20 gallons for '11-15 MIN'
                                            },
                                      style: ElevatedButton.styleFrom(
                                        backgroundColor:
                                    ...
                                    ElevatedButton(
                                      onPressed: isAnswered
                                          ...
                                          : () {
                                              updateGallonCount(
                                                  30); // Assume 5 gallons for 'OVER 15'
                                            },
                                      style: ElevatedButton.styleFrom(
                                        backgroundColor:
                              ...
                              Container(
                                ...
                                child: const Text(
                                  'Tip: Be honest. Do you waste water taking long, hot showers? A 10-minute shower uses 25 gallons or more. Challenge yourself by keeping the time to the length of two songs.',
                                  style: TextStyle(
                                    fontSize: 14,
                              ...
                              ElevatedButton(
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => UsageQuestion4(
                                        gallonCount:
