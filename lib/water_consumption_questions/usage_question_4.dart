...
import 'package:Puredrops/water_consumption_questions/usage_question_5.dart';
import 'package:flutter/material.dart';

class UsageQuestion4 extends StatefulWidget {
  final int gallonCount; // Gallon count from the previous screen
  final double waterLevel; // Water level from the previous screen

  const UsageQuestion4(
      {super.key, required this.gallonCount, required this.waterLevel});

  @override
  State<UsageQuestion4> createState() => _UsageQuestion4State();
}
                          ...
                          child: Column(
                            children: [
                                            ...
                                            showDialog(
                                              ...
                                              builder: (BuildContext context) {
                                                return AlertDialog(
                                                  ...
                                                  content: const Text(
                                                    'It’s fantastic that you don’t use a lot of water for watering your lawn or gardening. Conserving water in these areas can make a significant impact on our water resources. Keep being mindful of water usage in other areas as well to contribute to a more sustainable future!',
                                                    style: TextStyle(
                                                        color: Colors
                              ...
                              Container(
                                ...
                                child: const Text(
                                  'Tip: It takes over 600 gallons to water 1000 square feet to a depth of 1 inch.',
                                  style: TextStyle(
                                    fontSize: 14,
                              ...
                              ElevatedButton(
                                onPressed: () {
                                  ...
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => UsageQuestion5(
                                        gallonCount:
