...
import 'package:Puredrops/water_consumption_questions/usage_question_6.dart';
import 'package:flutter/material.dart';

class UsageQuestion5 extends StatefulWidget {
  final int gallonCount; // Gallon count from the previous screen
  final double waterLevel; // Water level from the previous screen

  const UsageQuestion5(
      {super.key, required this.gallonCount, required this.waterLevel});

  @override
  State<UsageQuestion5> createState() => _UsageQuestion5State();
}

class _UsageQuestion5State extends State<UsageQuestion5> {
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                ...
                                child: const Text(
                                  'Tip: If your home was built or remodeled after 1994, you probably have low-flow toilets, which use as little as 1.6 gallons per flush compared to the standard 5 to 7 gallons per flush.',
                                  style: TextStyle(
                                    fontSize: 14,
                              ...
                              ElevatedButton(
                                onPressed: () {
                                  ...
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => UsageQuestion6(
                                        gallonCount:
