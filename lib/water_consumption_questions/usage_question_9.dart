...
import 'package:Puredrops/water_consumption_questions/usage_question_10.dart';
import 'package:flutter/material.dart';

class UsageQuestion9 extends StatefulWidget {
  final int gallonCount; // Gallon count from the previous screen
  final double waterLevel; // Water level from the previous screen

  const UsageQuestion9(
      {super.key, required this.gallonCount, required this.waterLevel});

  @override
  State<UsageQuestion9> createState() => _UsageQuestion9State();
}
                          ...
                          child: Column(
                            children: [
                              Transform.translate(
                                ...
                                child: Image.asset(
                                  'assets/usages/Dishwashing.png', // Update with the new image
                                  width: 250,
                                  height: 180,
                                ),
                              ),
                              ...
                              Container(
                                ...
                                child: const Text(
                                  'Tip: Skip pre-rinsing when using a dishwasher and only run it when full. For handwashing, fill a basin instead of running the tap to save water.',
                                  style: TextStyle(
                                    fontSize: 14,
                              ...
                              ElevatedButton(
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => UsageQuestion10(
                                        gallonCount:
